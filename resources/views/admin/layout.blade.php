...
<head>
    ...
    {{--<link rel="stylesheet" href="/static/admin/layuiadmin/layui/css/laydate.css" media="all">--}}
        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="系统管理" class="layui-nav-item">
                    ...
                    <li data-name="场馆管理" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="场馆管理" >
                            <i class="layui-icon layui-icon-app"></i>
                            <cite>场馆管理</cite>
                        </a>
                        <dl class="layui-nav-child">
                            <dd data-name="场馆列表">
                                <a lay-href="{{route('admin.venues')}}">场馆列表</a>
                            </dd>
                        </dl>
                    </li>

                    <li data-name="会员管理" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="会员管理" >
                            <i class="layui-icon layui-icon-app"></i>
                            <cite>会员管理</cite>
                        </a>
                        <dl class="layui-nav-child">
